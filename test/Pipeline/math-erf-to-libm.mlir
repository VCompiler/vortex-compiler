...
// Verify that math.erf is lowered to a libm call (erff for f32).

module {
  func.func @erf_kernel(%in: memref<8xf32>, %out: memref<8xf32>) attributes {vortex.entry} {
